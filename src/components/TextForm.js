...
export default function TextForm(props) {
  ...
  return (
    ...
    <>
        ...
        <button className='btn btn-warning mx-2 my-2' onClick={handleColorYellow}>Change to Yellow Color</button>
        <button className='btn btn-primary mx-2 my-2' onClick={handleLowClick}>Convert to lowerCase</button>
        <button className='btn btn-danger mx-2 my-2' onClick={handleColorRed}>Change to Red Color</button>
    </div>
